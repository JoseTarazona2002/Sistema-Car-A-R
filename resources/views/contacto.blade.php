...
<div class="container bg-dark ">
    <div class="row mx-auto bg-light m-5">
        <div class="col-6 p-5">
            <div class="card-header">
                <h2 class="fst-italic text-primary">Ubicanos:</h2>
            </div>
            <div class="card-body">
                <h5 class="card-title">Direcciòn del local:</h5>
                <p class="card-text">M, Villa EL Salvador 15829</p>
                <h5 class="card-title mt-2">Telefono:</h5>
                <p class="card-text">+51 954 678 234</p>
                <h5 class="card-title mt-5 pt-5 mb-2 text-success">Siguenos:</h5>
                <p class="card-text">
        ...
        <div class="col-5 pt-5 mb-5">
            <h1 class="fst-italic m-3 text-primary">Contactanos:</h1>
            <div class="mb-3">
            <label for="exampleFormControlInput1" class="form-label">Ingrese un Correo Electronico:</label>
            <input type="email" class="form-control border-primary" id="exampleFormControlInput1" placeholder="usuario@correo.com">
            ...
            <div class="mb-3">
                <button type="submit" class="btn btn-outline-success">Enviar Mensaje</button>
            </div>
        </div>
