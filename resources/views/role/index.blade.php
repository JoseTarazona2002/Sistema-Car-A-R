...
<div class="container-fluid px-4">
    ...
    <ul class="pagination pt-3 pb-5">
        ...
        <span class="page-link">Roles</span>
        </li>
    </ul>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="btn-group" role="group" >
                                ...
                                @can('eliminar-role')
                                <button type="button" class="btn btn-outline-danger" data-bs-toggle="modal" data-bs-target="#confirmModal-{{$item->id}}">Eliminar</button>
                                @endcan
